...
#define         rVIC0VECTADDR21          ( *((volatile unsigned long *)(0xF2000154)) )
#define         rVIC0VECTADDR22          ( *((volatile unsigned long *)(0xF2000158)) )
#define         rVIC0VECTADDR23          ( *((volatile unsigned long *)(0xF200015C)) )
#define         rVIC0VECTADDR24          ( *((volatile unsigned long *)(0xF2000160)) )
...
#define rTCNTB2  (*(volatile unsigned int *)0xe2500024)
#define rTCMPB2  (*(volatile unsigned int *)0xe2500028)

#define rTCNTB3  (*(volatile unsigned int *)0xe2500030)
#define rTCMPB3  (*(volatile unsigned int *)0xe2500034)
...
#define rWINCON1                 (*(volatile unsigned long *)0xF8000024)
#define rWINCON2                 (*(volatile unsigned long *)0xF8000028)
#define rWINCON3                 (*(volatile unsigned long *)0xF800002C)
